	...
	<div class="container">
		...
		<section>
			...
			<div class="text-title cont text-center">
				Bem vindo a <strong>{{env('PROJECT_NAME')}}</strong>. Estamos muito felizes por se cadastrar.
			</div>

			<div class="text-title cont text-center">
			  Mas para você ter a experiência completa precisamos que você confirme o email com o código abaixo
			</div>

            <span class="text-title title">Seu Código: {{$code}}</span>
			...
			<div class="text-title cont text-center">
				...
				<div class="center">
						<a href="{{env('PROJECT_URL')}}/auth/login">LOGIN</a>	
				</div>
